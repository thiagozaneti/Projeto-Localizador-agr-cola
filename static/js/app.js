...
// Export Button
var showExport = '<a href="#" onclick="geojsonExport()" title="Salvar Geojson type="button" class="btn btn-danger btn-sm text-light"><i class="fa fa-file-code-o" aria-hidden="true"></i> Salvar Geojson</a>';
...
function geojsonExport(){
  let jsonData = JSON.stringify(drawnItems.toGeoJSON(), null, 2);
